            ...
            <div key={internship.id} className="col-md-6 mb-4">
              <Card>
                <Card.Body>
                  ...
                  {isEmployee && (
                    <Link to={`/InternshipApplication/${internship.id}`} className="btn btn-primary me-2">Apliko</Link>
                  )}
                  ...
                  {isCompany && companyId === parseInt(storedCompanyId) && (
                    <Link to={`/ApplicationsInternship/${internship.id}`} className="btn btn-secondary">Shiko aplikimet</Link>
                  )}
                </Card.Body>
              </Card>
            </div>
