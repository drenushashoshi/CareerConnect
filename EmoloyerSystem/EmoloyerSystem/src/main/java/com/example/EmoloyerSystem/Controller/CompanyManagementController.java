...
public class CompanyManagementController {
    ...
    public ResponseEntity<CompanyDto> updateCompany(@PathVariable Integer id, @RequestBody Company company){
        return ResponseEntity.ok(companyMenagmentService.updateCompany(id, company));
    }
